...
const appPublic = path.resolve(__dirname, 'app/public');
const srcApp = path.resolve(__dirname, 'app/.next-cli-build/server/app');
const srcStatic = path.resolve(__dirname, 'app/.next-cli-build/static');
...
console.log('✅ 9router root build complete!');
